...
const FloatingWhatsApp = () => {
  // YOUR BUSINESS WHATSAPP NUMBER (without +91 or 0)
  const BUSINESS_WHATSAPP_NUMBER = "9878165432";
  
  // Pre-filled message
const PRE_FILLED_MESSAGE = `Hi! I'm interested in your services. I found you from your website - thermopackers.com`;
  const handleWhatsAppClick = () => {
    // Encode the message for URL
    const encodedMessage = encodeURIComponent(PRE_FILLED_MESSAGE);
    
    // Open WhatsApp with number and pre-filled message

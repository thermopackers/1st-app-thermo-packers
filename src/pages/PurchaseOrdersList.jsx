...
// Add this function in your PurchaseOrdersList component
              ...
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className="border px-4 py-2">Action</th>
                      <th className="border px-4 py-2">PO Generated By</th> {/* NEW COLUMN */}
                  <th className="border px-4 py-2">PO Status</th>
<th className="border px-4 py-2">Approved By</th>
    <th className="border px-4 py-2">Cancelled By</th> {/* NEW COLUMN */}
                </tr>
              </thead>
            <tbody>
  {orders.map((order) => (
    <tr key={order._id}>
      ...
      <td className="border px-2 py-2 text-center">
        <div className="flex flex-col sm:flex-row sm:flex-wrap sm:justify-center gap-2">
          ...
          {order.status === "approved" && (
            ...
            >
              {loadingOrders.includes(order._id) ? "⏳ Processing..." : "🚫 Cancel PO"}
            </button>
          )}
        </div>
      </td>
      ...
      <td className="border px-4 py-2 text-center">
        {order.cancelledBy?.name || "-"} {/* NEW CELL */}
      </td>
    </tr>
  ))}
</tbody>

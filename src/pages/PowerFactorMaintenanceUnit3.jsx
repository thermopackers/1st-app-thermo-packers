...
const fetchWeeklyAverage = async () => {
  try {
    ...
    const res = await axiosInstance.get("/main-electric-panel-unit3/weekly-average"); // Change endpoint for Unit2/Unit3
...
className="absolute -top-2 -right-2 bg-red-500 text-white rounded-full w-4 h-4 text-xs"
      >
       ...
       <YouTubeGuide 
            ...
            title="Learn How to take Power Factor Readings - Unit 3"
          />
    </>
  );
}
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="text-left">
        <h3 className="text-xs font-semibold text-gray-900">
          📺 How to Check PH of water and Upload reading on ERP - Instruction Video
        </h3>
      ...
      <div className="flex items-start gap-4">
        <div className="flex-1">
          <p className="text-sm text-gray-600 mb-3">
            Watch this video to learn how to add, edit, and manage PH entries effectively.
          </p>
          <div className="relative w-full aspect-video rounded-lg overflow-hidden shadow-lg border border-gray-200">
            <iframe
              className="absolute top-0 left-0 w-full h-full"
              src="https://www.youtube.com/embed/XiMZWAVcgBw?si=crb_0vQ6O4mXUAHp"
              title="PH Monitoring Instruction Video"
              frameBorder="0"

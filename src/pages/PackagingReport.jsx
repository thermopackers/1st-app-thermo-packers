      ...
      <table className="w-full text-sm table-fixed">
        <thead className="bg-blue-600 text-white">
          <tr>
            ...
            <th className="px-3 py-2 text-center w-20">Pcs/Pkt</th>
            <th className="px-3 py-2 text-center w-24">Wet Wt</th>
            <th className="px-3 py-2 text-center w-24">Dry Wt</th>
            <th className="px-3 py-2 text-center w-24">Poly Size</th>
            <th className="px-3 py-2 text-center w-36">Packed Qty</th>
            <th className="px-3 py-2 text-center w-36">Dispatch</th>
            <th className="px-3 py-2 text-center w-36">Balance</th>
            <th className="px-3 py-2 text-center w-20">Tape</th>
                        ...
                        >
                          ...
                          <td className="px-2 py-1">
                            <textarea
                              ...
                              className="border rounded px-2 py-1 w-full min-w-[150px] resize-y text-sm"
                          ...
                          <td className="px-2 py-1 text-center">
                            <input
                              ...
                              readOnly
                              className="border rounded px-2 py-1 w-full bg-gray-100 text-center text-sm"
                              placeholder="Auto"
                            />
                          </td>
                          <td className="px-2 py-1">
